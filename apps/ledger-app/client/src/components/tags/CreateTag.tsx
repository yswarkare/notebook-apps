...
const CreateTag = ({ notebookId, createApi }: Props) => {
  ...
  return (
    <div className="w-full flex flex-col gap-3 justify-center items-center">
      <div className="flex self-end">
        {
          showInput ?
            ...
            :
            <button className="btn btn-outline btn-secondary btn-sm" type="button" onClick={() => { setShowInput(!showInput) }} >
      ...
      {
        showInput &&
        <form className="w-[50%] flex flex-col gap-3 justify-center items-center " onSubmit={handleSubmit(submitHandler)} >
